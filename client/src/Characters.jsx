    ...
    return (
        <>
            ...
            <div className="searchBar">
                <Stack direction="row">
                    <TextField fullWidth id="outlined-basic" label="Search" variant="outlined" size="medium" sx={{backgroundColor: "white"}} />
                    <Button variant="contained" sx={{backgroundColor: "#ffc000"}}> Search </Button>
                </Stack>
            </div>
            <Grid
                container
