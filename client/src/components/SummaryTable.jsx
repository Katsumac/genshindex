...
export default function SummaryTable({ summaryData }) {
  ...
  return (
    <TableContainer component={Paper} sx={{ minWidth: 100, maxWidth: {xs: 330, md: 500}, mb: 8 }} style={{ marginLeft: "auto", marginRight: "auto" }}>
      <Table sx={{ minWidth: 100, maxWidth: {xs: 330, md: 500}}} aria-label="customized table">
        <TableHead>
          <TableRow>
