...
export default function AbilityTable({ abilityData, secondColName }) {
  ...
  return (
    <TableContainer component={Paper} sx={{ minWidth: 200, maxWidth: {xs: 330, md: 1000}, mb: 8 }} style={{ marginLeft: "auto", marginRight: "auto" }}>
      <Table sx={{ minWidth: 200, maxWidth: {xs: 330, md: 1000}}} aria-label="customized table">
        <TableHead>
          <TableRow>
